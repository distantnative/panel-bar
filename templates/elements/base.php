<div class="panelbar-element <?php echo $class ?> panelbar--<?php echo $id ?> <?php echo r($mobile === false, 'not-mobile') ?> <?php echo r($compact === false, 'not-minimized') ?>" id="panelbar--<?php echo $id ?>">
